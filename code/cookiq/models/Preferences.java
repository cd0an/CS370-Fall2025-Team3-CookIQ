 ...
 * cooking preferences (time and budget), budget, and available ingredients.
 * 
 * Provides constructors for default empty preferences or for loading custom data.
 * Includes helper methods to copy, reset, and manage preferences.
 * 
 */
...
public class Preferences {
    ...
    // Constructor to load all preference data 
    ...
    // Copies all preferences from another Preferences object
